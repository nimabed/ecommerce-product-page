    ...
    <div className="absolute left-1/2 top-1/2 -translate-1/2 flex flex-col space-y-5 justify-center items-center">
      ...
      <div className="relative w-[580px] h-[560px]">
        <Image 
          ...
          fill
        />
        <button className="group absolute w-13 h-13 flex justify-center items-center bg-white -right-6 top-1/2 -translate-y-1/2 rounded-full pl-1 cursor-pointer">
          <ChevronRight strokeWidth={3} className="size-8 group-hover:text-primary" />
        </button>
        <button className="group absolute w-13 h-13 flex justify-center items-center bg-white -left-6 top-1/2 -translate-y-1/2 rounded-full pr-1 cursor-pointer">
      ...
      <div className="flex flex-row justify-between space-x-8 mt-3">
        ...
        <div className="relative w-20 h-20 bg-[url(/image-product-2-thumbnail.jpg)] bg-cover rounded-lg cursor-pointer group overflow-hidden">
          <div className="absolute inset-0 bg-white/50 opacity-0 group-hover:opacity-100" />
        </div>
        <div className="relative w-20 h-20 bg-[url(/image-product-3-thumbnail.jpg)] bg-cover rounded-lg cursor-pointer group overflow-hidden">
          <div className="absolute inset-0 bg-white/50 opacity-0 group-hover:opacity-100" />
        </div>
        <div className="relative w-20 h-20 bg-[url(/image-product-4-thumbnail.jpg)] bg-cover rounded-lg cursor-pointer group overflow-hidden">
          <div className="absolute inset-0 bg-white/50 opacity-0 group-hover:opacity-100" />
        </div>
      </div>
    </div>
