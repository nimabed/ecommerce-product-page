  ...
  return (
    <div className="flex justify-center items-center flex-1">
      <div className="w-full max-w-[375px] md:max-w-[600px] flex flex-col space-y-4 items-center">
        ...
        <Link href="/" className="w-full p-3 rounded-lg bg-primary font-bold text-center text-lg uppercase mt-2 hover:bg-primary/60 md:max-w-[90%] md:text-xl">Resume the trail: Back to hq</Link>
      </div>
    </div>
  )
}